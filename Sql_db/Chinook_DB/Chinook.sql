...
select customers.firstname||" "||customers.lastname as "full name", invoices.InvoiceId, Invoices.InvoiceDate, Invoices.BillingCountry from invoices inner join customers on invoices.CustomerId = customers.CustomerId where Country = 'Brazil';
